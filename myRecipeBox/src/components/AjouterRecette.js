    ...
    return(
      <div className="card">
        ...
        >
          ...
          <textarea ref={input => this.ingredients = input} rows="3" placeholder="Liste des ingrédients séparés par une virgule"/>

          <textarea ref={input => this.instructions = input} rows="3" placeholder="Liste des instructions ( une par ligne )"/>
